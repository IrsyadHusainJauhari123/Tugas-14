...
<body>
    ...
    <div class="search-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <span class="close-btn"><i class="fas fa-window-close"></i>
            ...
            <div class="row">
                    ...
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ url('public') }}/assets/img/products/product-img-1.jpg"
                                    alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
                        <p class="product-price">Per Kg 85$ </p>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        ...
                        <h3>Berry</h3>
                        <p class="product-price">Per Kg 70$ </p>
                        <a href="{{ url('cart') }}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to
                            Cart</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
                    <div class="single-product-item">
                        ...
                        <h3>Lemon</h3>
                        <p class="product-price">Per Kg 35$ </p>
                        <a href="{{ url('cart') }}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to
                            Cart</a>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                ...
                <div class="image-column col-lg-6">
                    <div class="image">
                        ...
                        <img src="{{ url('public') }}/assets/img/a.jpg" alt="">
                    </div>
                </div>
                <!--Content Column-->
                <div class="content-column col-lg-6">
                    <h3><span class="orange-text">Deal of the month</h3>
                    ...
                    <div class="time-counter">
                        <div class="time-countdown clearfix" data-countdown="2020/2/01">
                            <div class="counter-column">
                                <div class="inner"><span class="count">00Days</div>
                            </div>
                            <div class="counter-column">
                                <div class="inner"><span class="count">00Hours</div>
                            </div>
                            <div class="counter-column">
                                <div class="inner"><span class="count">00Mins</div>
                            </div>
                            <div class="counter-column">
                                <div class="inner"><span class="count">00Secs</div>
                            </div>
                        </div>
                    </div>
                    <a href="{{ url('cart') }}" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Add to
                        Cart</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-10 offset-lg-1 text-center">
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{ url('public') }}/assets/img/avaters/avatar2.png" alt="">
                        </div>
                        <div class="client-meta">
                            <h3>David Niph Local shop owner</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="abt-text">
                        ...
                        <h2>We are <span class="orange-text">Fruitkha</h2>
    ...
    <section class="shop-banner">
        <div class="container">
            <h3>December sale is on! <br> with big <span class="orange-text">Discount...</h3>
            <div class="sale-percent">Sale! <br> Upto50% off</div>
    ...
    <div class="latest-news pt-150 pb-150">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="section-title">
                        <h3><span class="orange-text">Our News</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, fuga quas itaque eveniet
                            beatae optio.</p>
                    </div>
                </div>
                        ...
                        <div class="news-text-box">
                            ...
                            <p class="blog-meta">
                                <span class="author"><i class="fas fa-user"></i> Admin
                                    <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019
                            </p>
