...
<body>
                ...
                <div class="col-lg-4">
                    <div class="contact-form-wrap">
                        <div class="contact-form-box">
                            ...
                            <p> west kalimatan <br> ketapang, kalbar <br> JL.Mayjen sutoyo/p>
                        </div>
                        <div class="contact-form-box">
                            <h4><i class="far fa-clock"></i> jam Buka</h4>
                            <p>Senin- Jumat: 8 to 9 pagi <br> SAT - SUN: 10 to 8 pagi </p>
                        </div>
                        <div class="contact-form-box">
                            <h4><i class="fas fa-address-book"></i> Contact</h4>
                            <p>Phone: 08981229812<br> Email: ariktpa@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- form validation js -->
    <script src="{{ url('public') }}/assets/js/form-validate.js"></script>
    <!-- main js -->
