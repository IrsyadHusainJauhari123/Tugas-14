@inject('timeServises', 'App\Services\TimeServices')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/produk/filter') }}" method="post">
                            ...
                            <button class="btn btn-primary float-right mt-1"><i class="fa fa-search"></i> Filter</button>
                        </form>
                    </div>
                </div>
                <div class="card">
